...
#include "robot_motion_interface_ros_msgs/msg/detail/object_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // handle
#include "rosidl_runtime_c/string_functions.h"  // handle
...
using _ObjectPose__ros_msg_type = robot_motion_interface_ros_msgs__msg__ObjectPose;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: handle
  {
    const rosidl_runtime_c__String * str = &ros_message->handle;
  ...
  robot_motion_interface_ros_msgs__msg__ObjectPose * ros_message)
{
  // Field name: handle
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->handle.data) {
      rosidl_runtime_c__String__init(&ros_message->handle);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->handle,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'handle'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_motion_interface_ros_msgs__msg__ObjectPose;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robot_motion_interface_ros_msgs__msg__ObjectPose * ros_message = static_cast<const robot_motion_interface_ros_msgs__msg__ObjectPose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robot_motion_interface_ros_msgs__msg__ObjectPose(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robot_motion_interface_ros_msgs__msg__ObjectPose * ros_message = static_cast<robot_motion_interface_ros_msgs__msg__ObjectPose *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robot_motion_interface_ros_msgs__msg__ObjectPose(cdr, ros_message);
}

static uint32_t _ObjectPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_motion_interface_ros_msgs__msg__ObjectPose(
...
static size_t _ObjectPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_motion_interface_ros_msgs__msg__ObjectPose(
