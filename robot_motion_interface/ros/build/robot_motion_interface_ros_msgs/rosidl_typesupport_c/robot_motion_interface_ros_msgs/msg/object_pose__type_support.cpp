...
static const _ObjectPose_type_support_symbol_names_t _ObjectPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_motion_interface_ros_msgs, msg, ObjectPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_motion_interface_ros_msgs, msg, ObjectPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_motion_interface_ros_msgs, msg, ObjectPose)() {
  return &::robot_motion_interface_ros_msgs::msg::rosidl_typesupport_c::ObjectPose_message_type_support_handle;
}
