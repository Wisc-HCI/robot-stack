...
static const _ObjectPoses_type_support_symbol_names_t _ObjectPoses_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_motion_interface_ros_msgs, msg, ObjectPoses)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_motion_interface_ros_msgs, msg, ObjectPoses)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_motion_interface_ros_msgs, msg, ObjectPoses)() {
  return &::robot_motion_interface_ros_msgs::msg::rosidl_typesupport_c::ObjectPoses_message_type_support_handle;
}
